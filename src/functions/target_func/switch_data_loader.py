...
class DistanceDatset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        states = self.info[scan_name][int(trajectory.split("_")[1])]
        ...
        start_pos = states['poses'][int(self.node_feat1[index])]
        start_rot = states['rotations'][int(self.node_feat1[index])]
        goal_pos = states['poses'][int(self.node_feat2[index])]
